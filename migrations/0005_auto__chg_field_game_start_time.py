...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'wolves_game', 'start_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Game.start_time'
        db.alter_column(u'wolves_game', 'start_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
