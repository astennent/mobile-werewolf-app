...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.admin'
        db.delete_column(u'wolves_game', 'admin_id')

        # Adding field 'Game.administrator'
        db.add_column(u'wolves_game', 'administrator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='game_admin', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Game.admin'
        db.add_column(u'wolves_game', 'admin',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='game_admin', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Game.administrator'
        db.delete_column(u'wolves_game', 'administrator_id')
